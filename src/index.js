...
module.exports = function toReadable (number) {
    ...
    if (number <= 99) {
        ...
        return (tenths(Math.floor(number / 10))) + " " + (zeroNine(number % 10));
    }
    if (number <= 999) {
        if (number % 100 === 0) {
            return (hundredths(number / 100));
        }
        if (number % 100 <= 9) {
            return (hundredths(Math.floor(number / 100))) + " " + (zeroNine(number % 100));
        }
        if (number % 100 <= 19 && number % 100 >= 10) {
            return (hundredths(Math.floor(number / 100))) + " " + (tenNineteen(number % 100));
        }
        if (number % 10 === 0) {
            return (hundredths(Math.floor(number / 100))) + " " + (tenths((number % 100) / 10));
        }
        return (hundredths(Math.floor(number / 100))) + " " + (tenths(Math.floor((number % 100) / 10))) + " " + (zeroNine(number % 10));
    }
}
